    ...
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden flex flex-col font-sans selection:bg-[#0066ff]/30">
      ...
      <nav className="relative z-50 px-8 py-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#0066ff]/20 group-hover:border-[#0066ff]/40 transition-all">
      ...
      <header className="relative z-20 px-8 pt-4 pb-12 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#0066ff]/10 border border-[#0066ff]/20 text-[#0099ff] text-[10px] font-black uppercase tracking-[0.3em]">
              <Database size={12} />
              Provider Registry
            </div>
            <div className="space-y-2">
              <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-white leading-none">
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0066ff] to-[#00d2ff]">Providers</span>
              </h1>
          ...
          >
            <div className="absolute inset-0 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite] bg-gradient-to-r from-transparent via-black/5 to-transparent" />
      ...
      <main className="relative z-20 flex-1 px-8 pb-32 max-w-7xl mx-auto w-full flex flex-col">
        ...
        <div className="mb-16 relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-[#0066ff]/20 to-[#00d2ff]/20 blur-3xl opacity-0 group-focus-within:opacity-100 transition-opacity" />
          <div className="relative">
            <div className="absolute inset-y-0 left-8 flex items-center pointer-events-none text-white/20 group-focus-within:text-[#0099ff] transition-colors">
              <Search size={24} />
            </div>
            <input
              type="text"
              ...
              className="w-full bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] pl-20 pr-8 py-8 text-2xl font-bold outline-none focus:border-[#0099ff]/50 focus:bg-white/10 focus:ring-1 focus:ring-[#0099ff]/20 transition-all shadow-2xl placeholder:text-white/10 tracking-tight"
            />
          </div>
        </div>
        ...
        <div className="flex-1">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-40 gap-6">
              <div className="relative">
                <div className="absolute inset-0 bg-[#0066ff] blur-3xl opacity-20 animate-pulse" />
                <Loader2 className="animate-spin text-[#0099ff] relative z-10" size={64} />
              </div>
            ...
            <div className="py-40 text-center space-y-8 bg-white/5 rounded-[4rem] border border-white/10 border-dashed backdrop-blur-sm">
              <div className="w-24 h-24 rounded-full bg-white/5 border border-white/5 flex items-center justify-center mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProviders.map((p, i) => (
                <div 
                  key={p.id} 
                  className="group relative rounded-[3rem] bg-[#0a0a0a]/80 backdrop-blur-3xl border border-white/10 hover:border-[#0099ff]/50 transition-all duration-700 shadow-2xl hover:shadow-[0_40px_100px_rgba(0,102,255,0.15)] hover:-translate-y-2 overflow-hidden flex flex-col animate-fadeInUp"
                  style={{ animationDelay: `${i * 50}ms` }}
                >
                  {/* Card Glow Effect */}
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#0066ff]/20 to-transparent blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                  ...
                  <div className="relative z-10 p-10 flex-1 flex flex-col">
                    <div className="flex items-start justify-between mb-10">
                      ...
                      <div className="flex gap-3">
                        <button 
                          ...
                          className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/20 hover:text-white hover:bg-[#0066ff] hover:border-[#0066ff] hover:scale-110 transition-all duration-300"
                        >
                          <Edit3 size={18} />
                        </button>
                        <button 
                          onClick={() => handleDelete(p.id)}
                          className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/20 hover:text-white hover:bg-red-500 hover:border-red-500 hover:scale-110 transition-all duration-300"
                        >
                          <Trash2 size={18} />
                        </button>
                      </div>
                    ...
                    <div className="space-y-3 mb-10">
                      <h3 className="text-3xl font-black text-white tracking-tighter group-hover:text-[#0099ff] transition-colors duration-500 leading-none">
                        {p.name}
                      </h3>
                      <div className="flex items-center gap-2 text-[10px] text-white/20 uppercase tracking-[0.3em] font-black group-hover:text-[#0099ff]/50 transition-colors">
                        Service Provider
                      </div>
                    </div>
                    ...
                    <div className="mt-auto pt-8 border-t border-white/5 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#0099ff] opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-700">
...
function SocialButton({ href, icon: Icon, label }: { href?: string | null; icon: React.ElementType; label: string }) {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-2xl bg-white/5 group-hover/btn:bg-[#0066ff]/20 border border-white/5 group-hover/btn:border-[#0066ff]/40 flex items-center justify-center text-white/40 group-hover/btn:text-[#0099ff] transition-all">
        <Icon size={20} />
      </div>
